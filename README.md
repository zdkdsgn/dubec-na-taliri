...
- **Umí přepnout na jinou školu** — Info → „Vaše škola" nabídne rychlý výběr z appkou podporovaných škol a živé hledání (přes vlastní Cloudflare proxy, viz `cloudflare/skoly-proxy/`) mezi školami na jidelna.cz. Výchozí zůstává Dubeč, síťový dotaz navíc jen když si někdo vybere jinou školu
